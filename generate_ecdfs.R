...
extracted_dir = "Extractions and Summaries/Extract Service Areas"
...
output_dir_sa = "Extractions and Summaries/SA ECDF Functions"
...
compute_ecdf_functions <- function(df, sa_name) {
  ...
  # Read bank extract
  bank_extract <- readRDS("Extractions and Summaries/Extract Banks/all_bank_extractions.rds")
...
output_dir_banks <- file.path("Extractions and Summaries/Bank ECDF Functions")
...
extracted_dir <- "Wetland Loss/Extractions and Summaries/Extract Service Area Loss"             # Where the .rds extracted data live
output_dir_sa <- file.path(extracted_dir, "Wetland Loss/Extractions and Summaries/Loss ECDF Functions")            # Where to save the summary files
...
compute_ecdf_functions <- function(df, sa_name) {
  ...
  # Read bank extract
  bank_extract <- readRDS("Wetland Loss/Extractions and Summaries/Extract Service Area Loss/bank_extractions.rds")
